...
def flop_parser(line_arr, module_name, inout_list, wire_dict, input_dict, output_dict):
    final_arr = []
    flop_dict = {"DFFX1":["Q", "CK", "D", "QN"], "DFFR_X1":["Q", "CK", "D", "QN", "RN"], "DFFS_X1":["Q", "CK", "D", "QN", "SN"], "DFF_X1":["Q", "CK", "D", "QN"], "DFF_X2":["Q", "CK", "D", "QN"], "DFFSRX1":["Q", "CK", "D", "QN", "SN", "RN"], "SDFF_X1":["Q", "CK", "D", "QN", "SI", "SE"], "SDFF_X2":["Q", "CK", "D", "QN", "SI", "SE"], "SDFFSRX1":["Q", "CK", "D", "QN", "SN", "RN"]}
    flop_cnt = 0
    input_q_dict = {}
    input_qn_dict = {}
    for i,line in enumerate(line_arr):
    ...
    for key in wire_dict.keys():
        wire_line = "wire "
        for num, wire in enumerate(wire_dict[key]):
            wire_line = wire_line + wire + ", "
            if(num > 40 and num%50 == 0):
                wire_line = wire_line + "\n  "
    ...
    #Reinser qn and q inputs
    for key in input_q_dict.keys():
        input_line = "input "
        for input_ in input_q_dict[key]:
            input_line = input_line + input_ + ", "
        input_line = input_line[:-2] + ";\n"
        final_arr.insert(0, input_line)
    for key in input_qn_dict.keys():
        input_line = "input "
        for input_ in input_qn_dict[key]:
            input_line = input_line + input_ + ", "
        input_line = input_line[:-2] + ";\n"
        final_arr.insert(0, input_line)
